...
#define PROID			"gf0B67Ey48"

#define ACCESS_KEY		"aExMTjQ0OUJiQVZkM3l2RkFXUmZUUDYwZ2VBYmtVMVA="
...
_Bool OneNET_RegisterDevice(void)
{
	...
	OneNET_Authorization("2018-10-31", PROID, 2084879689, ACCESS_KEY, NULL,
...
_Bool OneNet_DevLink(void)
{
	...
	OneNET_Authorization("2018-10-31", PROID, 2084879689, ACCESS_KEY, DEVICE_NAME,
